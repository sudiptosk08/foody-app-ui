                                ...
                                child: ClipRRect(
                                    ...
                                    child: Container(
                                        decoration: BoxDecoration(
                                          boxShadow: [
                                            BoxShadow(
                                              color: KColor.gray.withAlpha(50),
                                              offset: Offset(20, 0),
                                              spreadRadius: 40.00,
                                            ),
                                            BoxShadow(
                                              color: KColor.gray.withAlpha(10),
                                              offset: Offset(0, 13),
                                              spreadRadius: 40.00,
                                            ),
                                          ],
    ...
    if (widget.scrollable) {
      ...
      return Column(
        ...
        children: [
          ...
          Padding(
            padding:EdgeInsets.only(left: KSize.getWidth(context, 12)),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: widget.items,
            ),
          ...
          child: Padding(
            ...
            child: Row(
              children: <Widget>[
                Container(
                  padding: EdgeInsets.only(
                      left: KSize.getWidth(context, 15), right: 13.0),
                  child: icon,
                ),
                text,
              ],
